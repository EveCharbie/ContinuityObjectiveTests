...
def extract_keys(filename):
    ...
    if filename[0] == "objective":
        ...
        type_, var, phase, case, weight, weight_sphere, iter_ = filename[0], None, None, filename[1], filename[2], filename[3], filename[4]
        case = int(case)
        return dict(type=type_, var=var, phase=phase, case=case, weight=weight, weight_sphere=weight_sphere, iter=iter_)
